...
public class TelaEmprestimo extends javax.swing.JFrame {
   ...
   */
  public TelaEmprestimo(List<Usuario> usuarios, List<Livro> livros, List<Emprestimo> emprestimos) {
  ...
  private void carregarLivros() {
    ...
    for(Livro l : livros) {
      ((DefaultTableModel) tabelaLivros.getModel()).addRow(l.carregarGrid());
    }
  }
  ...
  private void emprestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emprestarActionPerformed
    ...
    //TODO - Validar se escolheu um usuário e pelo menos um livro.
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new TelaEmprestimo(new ArrayList<Usuario>(), new ArrayList<Livro>(), 
                new ArrayList<Emprestimo>()).setVisible(true);
      }
    });
  }
