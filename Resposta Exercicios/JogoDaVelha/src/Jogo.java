...
public class Jogo extends javax.swing.JFrame {
  ...
  public void verificarSeGanhouOuEmpatou() {
    ...
    if (!r21.getText().equals("") && r21.getText().equals(r22.getText()) && r21.getText().equals(r23.getText())) {
      vencedor = r21.getText();
    } else 
      /* Verifica se toda a terceira linha está marcada com o mesmo texto. */ 
      if (!r31.getText().equals("") && r31.getText().equals(r32.getText()) && r31.getText().equals(r33.getText())) {
      vencedor = r31.getText();
    } else 
      /* Verifica se toda a primeira coluna está marcada com o mesmo texto. */ 
      if (!r11.getText().equals("") && r11.getText().equals(r21.getText()) && r11.getText().equals(r31.getText())) {
      vencedor = r11.getText();
    } else 
      /* Verifica se toda a segunda coluna está marcada com o mesmo texto. */ 
      if (!r12.getText().equals("") && r12.getText().equals(r22.getText()) && r12.getText().equals(r32.getText())) {
      vencedor = r12.getText();
    } else 
      /* Verifica se toda a terceica coluna está marcada com o mesmo texto. */ 
      if (!r13.getText().equals("") && r13.getText().equals(r23.getText()) && r13.getText().equals(r33.getText())) {
      vencedor = r13.getText();
    } else 
      /* Verifica se toda a diagonal da esquerda para a direita está marcada com o mesmo texto. */ 
      if (!r11.getText().equals("") && r11.getText().equals(r22.getText()) && r11.getText().equals(r33.getText())) {
      vencedor = r11.getText();
    } else 
        /* Verifica se toda a diagonal da direita para a esquerda está marcada com o mesmo texto. */ if (!r13.getText().equals("") && r13.getText().equals(r22.getText()) && r13.getText().equals(r31.getText())) {
      vencedor = r13.getText();
    }
  ...
  private void initComponents() {
    ...
    r11.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r11.setBounds(45, 76, 90, 90);

    r12.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r12.setBounds(135, 76, 90, 80);

    r13.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r13.setBounds(235, 76, 90, 80);

    r21.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r21.setBounds(50, 166, 80, 80);

    r22.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r22.setBounds(140, 160, 90, 90);

    r23.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r23.setBounds(235, 160, 80, 90);

    r31.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r31.setBounds(45, 250, 90, 90);

    r32.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    ...
    r32.setBounds(140, 256, 90, 90);

    r33.setFont(new java.awt.Font("Lucida Grande", 0, 48)); // NOI18N
    r33.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    r33.setMinimumSize(new java.awt.Dimension(370, 465));
    ...
    r33.setBounds(235, 250, 90, 90);

    fundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fundo.png"))); // NOI18N
